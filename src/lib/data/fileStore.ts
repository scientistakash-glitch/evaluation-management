...
// Helper: compute category-wise seats from total using standard Indian reservation
function catSeats(total: number): Record<string, number> {
  return {
    General: Math.round(total * 0.50),
    OBC:     Math.round(total * 0.27),
    SC:      Math.round(total * 0.15),
    ST:      Math.round(total * 0.05),
    EWS:     Math.round(total * 0.03),
  };
}
...
const SEED_READONLY: Record<string, any[]> = {
  ...
  'lpps.json': [
    // B.Tech (4 programs)
    { id: 'lpp_001', ptatId: 'ptat_001', name: 'B.Tech CSE',              code: 'BTECH_CSE',   duration: 4, totalSeats: 120, categoryWiseSeats: catSeats(120), subcategories: [{ name: 'Resident Indian', category: 'Resident Indian', approvedIntake: 60 }, { name: 'Gujarati Minority', category: 'Resident Indian', approvedIntake: 60 }], createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
    { id: 'lpp_002', ptatId: 'ptat_001', name: 'B.Tech Mechanical',       code: 'BTECH_MECH',  duration: 4, totalSeats:  60, categoryWiseSeats: catSeats(60),  subcategories: [{ name: 'Resident Indian', category: 'Resident Indian', approvedIntake: 30 }, { name: 'Gujarati Minority', category: 'Resident Indian', approvedIntake: 30 }], createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
    { id: 'lpp_003', ptatId: 'ptat_001', name: 'B.Tech ECE',              code: 'BTECH_ECE',   duration: 4, totalSeats:  90, categoryWiseSeats: catSeats(90),  subcategories: [{ name: 'Resident Indian', category: 'Resident Indian', approvedIntake: 45 }, { name: 'Gujarati Minority', category: 'Resident Indian', approvedIntake: 45 }], createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
    { id: 'lpp_004', ptatId: 'ptat_001', name: 'B.Tech Civil',            code: 'BTECH_CIVIL', duration: 4, totalSeats:  60, categoryWiseSeats: catSeats(60),  subcategories: [{ name: 'Resident Indian', category: 'Resident Indian', approvedIntake: 30 }, { name: 'Gujarati Minority', category: 'Resident Indian', approvedIntake: 30 }], createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
    // M.Tech (3 programs)
  ...
  'applications.json': [
    ...
    { id: 'app_008', studentName: 'Kavya Reddy',       rollNumber: 'JEE24008', dateOfBirth: '2003-12-03', category: 'SC',      lppPreference: 'lpp_001', entranceScore: 281, academicScore: 91.0, interviewScore: 86, applicationDate: '2024-02-08', createdAt: '2024-02-08T00:00:00Z', updatedAt: '2024-02-08T00:00:00Z' },
    { id: 'app_009', studentName: 'Aditya Kumar',      rollNumber: 'JEE24009', dateOfBirth: '2003-07-19', category: 'SC',      lppPreference: 'lpp_001', entranceScore: 260, academicScore: 83.5, interviewScore: 72, applicationDate: '2024-02-12', createdAt: '2024-02-12T00:00:00Z', updatedAt: '2024-02-12T00:00:00Z' },
    { id: 'app_010', studentName: 'Meera Krishnan',    rollNumber: 'JEE24010', dateOfBirth: '2003-04-08', category: 'ST',      lppPreference: 'lpp_001', entranceScore: 295, academicScore: 97.0, interviewScore: 95, applicationDate: '2024-02-15', createdAt: '2024-02-15T00:00:00Z', updatedAt: '2024-02-15T00:00:00Z' },
    { id: 'app_011', studentName: 'Karan Mehta',       rollNumber: 'JEE24011', dateOfBirth: '2003-01-20', category: 'EWS',     lppPreference: 'lpp_001', entranceScore: 272, academicScore: 88.0, interviewScore: 80, applicationDate: '2024-02-20', createdAt: '2024-02-20T00:00:00Z', updatedAt: '2024-02-20T00:00:00Z' },
    ...
    { id: 'app_016', studentName: 'Manish Pandey',     rollNumber: 'JEE24016', dateOfBirth: '2003-03-21', category: 'SC',      lppPreference: 'lpp_002', entranceScore: 228, academicScore: 70.5, interviewScore: 55, applicationDate: '2024-03-05', createdAt: '2024-03-05T00:00:00Z', updatedAt: '2024-03-05T00:00:00Z' },
    { id: 'app_017', studentName: 'Geeta Maurya',      rollNumber: 'JEE24017', dateOfBirth: '2003-11-09', category: 'ST',      lppPreference: 'lpp_002', entranceScore: 245, academicScore: 77.9, interviewScore: 64, applicationDate: '2024-03-08', createdAt: '2024-03-08T00:00:00Z', updatedAt: '2024-03-08T00:00:00Z' },
    { id: 'app_018', studentName: 'Santosh Bind',      rollNumber: 'JEE24018', dateOfBirth: '2003-06-17', category: 'EWS',     lppPreference: 'lpp_002', entranceScore: 220, academicScore: 67.5, interviewScore: 50, applicationDate: '2024-03-12', createdAt: '2024-03-12T00:00:00Z', updatedAt: '2024-03-12T00:00:00Z' },
    ...
    { id: 'app_022', studentName: 'Ajay Paswan',       rollNumber: 'JEE24022', dateOfBirth: '2003-04-16', category: 'SC',      lppPreference: 'lpp_003', entranceScore: 218, academicScore: 68.0, interviewScore: 52, applicationDate: '2024-04-01', createdAt: '2024-04-01T00:00:00Z', updatedAt: '2024-04-01T00:00:00Z' },
    { id: 'app_023', studentName: 'Rekha Chamar',      rollNumber: 'JEE24023', dateOfBirth: '2003-07-28', category: 'ST',      lppPreference: 'lpp_003', entranceScore: 205, academicScore: 63.5, interviewScore: 45, applicationDate: '2024-04-05', createdAt: '2024-04-05T00:00:00Z', updatedAt: '2024-04-05T00:00:00Z' },
    { id: 'app_024', studentName: 'Vinod Valmiki',     rollNumber: 'JEE24024', dateOfBirth: '2003-01-13', category: 'EWS',     lppPreference: 'lpp_003', entranceScore: 225, academicScore: 71.2, interviewScore: 57, applicationDate: '2024-04-10', createdAt: '2024-04-10T00:00:00Z', updatedAt: '2024-04-10T00:00:00Z' },
    ...
    { id: 'app_028', studentName: 'Nagesh Gond',        rollNumber: 'JEE24028', dateOfBirth: '2003-03-14', category: 'SC',      lppPreference: 'lpp_004', entranceScore: 192, academicScore: 65.0, interviewScore: 46, applicationDate: '2024-05-10', createdAt: '2024-05-10T00:00:00Z', updatedAt: '2024-05-10T00:00:00Z' },
    { id: 'app_029', studentName: 'Kamla Bhil',         rollNumber: 'JEE24029', dateOfBirth: '2003-11-22', category: 'ST',      lppPreference: 'lpp_004', entranceScore: 168, academicScore: 61.5, interviewScore: 41, applicationDate: '2024-05-20', createdAt: '2024-05-20T00:00:00Z', updatedAt: '2024-05-20T00:00:00Z' },
    { id: 'app_030', studentName: 'Rahul Srivastava',   rollNumber: 'JEE24030', dateOfBirth: '2003-06-09', category: 'EWS',     lppPreference: 'lpp_004', entranceScore: 272, academicScore: 88.0, interviewScore: 80, applicationDate: '2024-06-01', createdAt: '2024-06-01T00:00:00Z', updatedAt: '2024-06-01T00:00:00Z' },
    ...
    { id: 'app_034', studentName: 'Sunil Desai',        rollNumber: 'GATE24004', dateOfBirth: '2001-11-03', category: 'SC',      lppPreference: 'lpp_005', entranceScore: 248, academicScore: 79.0, interviewScore: 67, applicationDate: '2024-07-01', createdAt: '2024-07-01T00:00:00Z', updatedAt: '2024-07-01T00:00:00Z' },
    { id: 'app_035', studentName: 'Kavitha Nair',       rollNumber: 'GATE24005', dateOfBirth: '2001-04-17', category: 'ST',      lppPreference: 'lpp_005', entranceScore: 232, academicScore: 74.5, interviewScore: 60, applicationDate: '2024-07-05', createdAt: '2024-07-05T00:00:00Z', updatedAt: '2024-07-05T00:00:00Z' },
    ...
    { id: 'app_038', studentName: 'Prakash Nadar',      rollNumber: 'GATE24008', dateOfBirth: '2001-12-11', category: 'SC',      lppPreference: 'lpp_006', entranceScore: 240, academicScore: 75.5, interviewScore: 61, applicationDate: '2024-07-20', createdAt: '2024-07-20T00:00:00Z', updatedAt: '2024-07-20T00:00:00Z' },
    { id: 'app_039', studentName: 'Indira Gowda',       rollNumber: 'GATE24009', dateOfBirth: '2001-03-25', category: 'EWS',     lppPreference: 'lpp_006', entranceScore: 255, academicScore: 81.0, interviewScore: 70, applicationDate: '2024-07-25', createdAt: '2024-07-25T00:00:00Z', updatedAt: '2024-07-25T00:00:00Z' },
    ...
    { id: 'app_042', studentName: 'Ravi Bhatt',         rollNumber: 'GATE24012', dateOfBirth: '2001-04-28', category: 'ST',      lppPreference: 'lpp_007', entranceScore: 218, academicScore: 68.5, interviewScore: 52, applicationDate: '2024-08-10', createdAt: '2024-08-10T00:00:00Z', updatedAt: '2024-08-10T00:00:00Z' },
    ...
    { id: 'app_047', studentName: 'Sundar Rajan',       rollNumber: 'CAT24005', dateOfBirth: '1999-09-16', category: 'SC',      lppPreference: 'lpp_008', entranceScore: 235, academicScore: 74.0, interviewScore: 60, applicationDate: '2024-09-01', createdAt: '2024-09-01T00:00:00Z', updatedAt: '2024-09-01T00:00:00Z' },
    { id: 'app_048', studentName: 'Usha Pillai',        rollNumber: 'CAT24006', dateOfBirth: '1999-12-28', category: 'ST',      lppPreference: 'lpp_008', entranceScore: 222, academicScore: 70.0, interviewScore: 54, applicationDate: '2024-09-05', createdAt: '2024-09-05T00:00:00Z', updatedAt: '2024-09-05T00:00:00Z' },
    { id: 'app_049', studentName: 'Vivek Menon',        rollNumber: 'CAT24007', dateOfBirth: '1999-06-11', category: 'EWS',     lppPreference: 'lpp_008', entranceScore: 268, academicScore: 86.0, interviewScore: 78, applicationDate: '2024-09-10', createdAt: '2024-09-10T00:00:00Z', updatedAt: '2024-09-10T00:00:00Z' },
    ...
    { id: 'app_053', studentName: 'Esha Tripathi',      rollNumber: 'CAT24011', dateOfBirth: '2000-12-10', category: 'SC',      lppPreference: 'lpp_009', entranceScore: 225, academicScore: 71.5, interviewScore: 55, applicationDate: '2024-09-25', createdAt: '2024-09-25T00:00:00Z', updatedAt: '2024-09-25T00:00:00Z' },
    { id: 'app_054', studentName: 'Farhan Siddiqui',    rollNumber: 'CAT24012', dateOfBirth: '2000-03-22', category: 'EWS',     lppPreference: 'lpp_009', entranceScore: 258, academicScore: 82.0, interviewScore: 72, applicationDate: '2024-10-01', createdAt: '2024-10-01T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
    ...
    { id: 'app_057', studentName: 'Ishaan Bose',        rollNumber: 'CAT24015', dateOfBirth: '2000-01-27', category: 'SC',      lppPreference: 'lpp_010', entranceScore: 242, academicScore: 77.0, interviewScore: 63, applicationDate: '2024-10-15', createdAt: '2024-10-15T00:00:00Z', updatedAt: '2024-10-15T00:00:00Z' },
    { id: 'app_058', studentName: 'Jyoti Kureel',       rollNumber: 'CAT24016', dateOfBirth: '2000-04-09', category: 'ST',      lppPreference: 'lpp_010', entranceScore: 228, academicScore: 72.5, interviewScore: 56, applicationDate: '2024-10-20', createdAt: '2024-10-20T00:00:00Z', updatedAt: '2024-10-20T00:00:00Z' },
    ...
    { id: 'app_061', studentName: 'Mohan Bairwa',       rollNumber: 'CAT24019', dateOfBirth: '2000-12-05', category: 'SC',      lppPreference: 'lpp_011', entranceScore: 237, academicScore: 75.0, interviewScore: 60, applicationDate: '2024-11-05', createdAt: '2024-11-05T00:00:00Z', updatedAt: '2024-11-05T00:00:00Z' },
    { id: 'app_062', studentName: 'Nisha Meena',        rollNumber: 'CAT24020', dateOfBirth: '2000-03-17', category: 'EWS',     lppPreference: 'lpp_011', entranceScore: 245, academicScore: 78.0, interviewScore: 65, applicationDate: '2024-11-10', createdAt: '2024-11-10T00:00:00Z', updatedAt: '2024-11-10T00:00:00Z' },
    ...
    { id: 'app_066', studentName: 'Rani Devi',          rollNumber: 'IIT24004', dateOfBirth: '2001-11-28', category: 'SC',      lppPreference: 'lpp_012', entranceScore: 240, academicScore: 76.5, interviewScore: 62, applicationDate: '2024-11-25', createdAt: '2024-11-25T00:00:00Z', updatedAt: '2024-11-25T00:00:00Z' },
    { id: 'app_067', studentName: 'Santanu Munda',      rollNumber: 'IIT24005', dateOfBirth: '2001-05-10', category: 'ST',      lppPreference: 'lpp_012', entranceScore: 226, academicScore: 72.0, interviewScore: 55, applicationDate: '2024-12-01', createdAt: '2024-12-01T00:00:00Z', updatedAt: '2024-12-01T00:00:00Z' },
    ...
    { id: 'app_070', studentName: 'Vandana Jadhav',     rollNumber: 'IIT24008', dateOfBirth: '2001-09-21', category: 'SC',      lppPreference: 'lpp_013', entranceScore: 247, academicScore: 79.0, interviewScore: 65, applicationDate: '2024-12-12', createdAt: '2024-12-12T00:00:00Z', updatedAt: '2024-12-12T00:00:00Z' },
    { id: 'app_071', studentName: 'Wasim Khan',         rollNumber: 'IIT24009', dateOfBirth: '2001-12-31', category: 'EWS',     lppPreference: 'lpp_013', entranceScore: 263, academicScore: 84.0, interviewScore: 75, applicationDate: '2024-12-15', createdAt: '2024-12-15T00:00:00Z', updatedAt: '2024-12-15T00:00:00Z' },
    ...
    { id: 'app_075', studentName: 'Abhishek Pandey',    rollNumber: 'IIT24013', dateOfBirth: '2001-01-15', category: 'SC',      lppPreference: 'lpp_014', entranceScore: 243, academicScore: 77.5, interviewScore: 62, applicationDate: '2024-12-28', createdAt: '2024-12-28T00:00:00Z', updatedAt: '2024-12-28T00:00:00Z' },
    { id: 'app_076', studentName: 'Bhawana Bhagat',     rollNumber: 'IIT24014', dateOfBirth: '2001-04-22', category: 'ST',      lppPreference: 'lpp_014', entranceScore: 230, academicScore: 73.0, interviewScore: 57, applicationDate: '2024-12-30', createdAt: '2024-12-30T00:00:00Z', updatedAt: '2024-12-30T00:00:00Z' },
