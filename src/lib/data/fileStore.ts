...
const SEED_READONLY: Record<string, any[]> = {
  ...
  'lpps.json': [
    ...
    { id: 'lpp_003', ptatId: 'ptat_001', name: 'B.Tech EXTC',                     code: 'BTECH_EXTC',  duration: 4, fee: 740000,  totalSeats:  90, categoryWiseSeats: catSeats(90),  subcategories: [{ name: 'General', category: 'Resident Indian', approvedIntake: 34 }, { name: 'OBC', category: 'Resident Indian', approvedIntake: 24 }, { name: 'SC/ST', category: 'Resident Indian', approvedIntake: 21 }, { name: 'American', category: 'NRI', approvedIntake: 6 }, { name: 'Arab', category: 'NRI', approvedIntake: 5 }], createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
